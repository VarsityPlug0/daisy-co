...
export default function ClothingPage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Banner */}
      <section className="relative overflow-hidden bg-gradient-to-b from-[#141414] to-[#111111] border-b border-[#2A2A2A] py-16 md:py-24">
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#C8B993_1px,transparent_1px)] [background-size:24px_24px]" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            {/* Hero Text */}
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#C8B993]/15 border border-[#C8B993]/40 text-[#C8B993] text-xs font-bold uppercase tracking-wider animate-pulse">
                <Sparkles size={14} /> Coming Soon — Official Streetwear Drop
              </div>

              <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-white tracking-tight leading-[1.1]">
                Urban Luxury & <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C8B993] via-[#F3E5AB] to-[#AA771C]">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
                <a
                  ...
                  className="btn-gold px-8 py-4 rounded-xl font-extrabold text-sm flex items-center gap-2 shadow-xl shadow-[#C8B993]/20"
                >
                  <Sparkles size={16} /> Notify Me on Drop
                </a>
                <a
                  href="#catalog"
                  className="px-6 py-4 rounded-xl font-bold text-sm text-gray-300 border border-[#2a2a2a] bg-[#141414] hover:bg-[#2A2A2A] hover:text-white hover:border-gray-500 transition-all flex items-center gap-2"
                >
                  <Eye size={16} className="text-[#C8B993]" /> Preview Drop Catalog
                </a>
              </div>

              {/* Guarantees */}
              <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[#2A2A2A] max-w-lg mx-auto lg:mx-0">
                <div className="flex flex-col items-center lg:items-start text-xs text-gray-400">
                  <Truck size={18} className="text-[#C8B993] mb-1" />
                  <span className="font-bold text-white">Same-Day SA Delivery</span>
                  <span>Fast shipping</span>
                </div>
                <div className="flex flex-col items-center lg:items-start text-xs text-gray-400">
                  <RefreshCw size={18} className="text-[#C8B993] mb-1" />
                  <span className="font-bold text-white">Free Size Swaps</span>
                  <span>7-day return policy</span>
                </div>
                <div className="flex flex-col items-center lg:items-start text-xs text-gray-400">
                  <ShieldCheck size={18} className="text-[#C8B993] mb-1" />
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md aspect-[4/5] rounded-3xl overflow-hidden border border-[#C8B993]/40 shadow-2xl shadow-black/80">
                <Image
                ...
                <div className="absolute top-4 right-4 bg-[#C8B993] text-black font-black text-[11px] uppercase tracking-wider px-3 py-1 rounded-full shadow-lg">
                  COMING SOON
                </div>
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-black/70 backdrop-blur-md border border-white/10">
                  <p className="text-xs text-[#C8B993] font-bold uppercase tracking-wider">Upcoming Drop</p>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <span className="text-[10px] bg-[#C8B993]/20 border border-[#C8B993] text-[#C8B993] font-bold px-2.5 py-0.5 rounded-full">DROPPING SOON</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
          <div>
            <p className="text-[#C8B993] text-xs uppercase tracking-widest font-bold mb-2">Explore Departments</p>
            <h2 className="text-3xl font-extrabold text-white">Upcoming Collections</h2>
          </div>
          <Link href="/shop" className="text-sm font-semibold text-gray-400 hover:text-[#C8B993] flex items-center gap-1.5 transition-colors">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {FEATURED_CATS.map((c) => (
            <Link
              ...
              className="group relative rounded-2xl overflow-hidden aspect-[3/4] bg-[#1D1D1D] border border-[#2A2A2A] hover:border-[#C8B993]/50 transition-all shadow-lg hover:shadow-xl hover:shadow-[#C8B993]/10"
            >
              <Image
                src={c.img}
                alt={c.name}
              ...
              <div className="absolute top-3 left-3">
                <span className="text-[9px] font-extrabold uppercase tracking-wider px-2 py-0.5 rounded-full bg-[#111111]/90 text-[#C8B993] border border-[#C8B993]/40 backdrop-blur-sm">
                  {c.tag}
                </span>
              </div>
              <div className="absolute bottom-4 left-4 right-4 space-y-1">
                <h3 className="text-sm sm:text-base font-bold text-white group-hover:text-[#C8B993] transition-colors">
                  {c.name}
                </h3>
      ...
      <section id="catalog" className="max-w-7xl mx-auto px-4 sm:px-8 py-10 scroll-mt-24">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 border-b border-[#2A2A2A] pb-6">
          <div>
            <span className="text-xs text-[#C8B993] font-bold uppercase tracking-wider">Preview Drop</span>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white">Apparel & Footwear Preview (Coming Soon)</h2>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link href="/shop?cat=Clothing%20%26%20Apparel" className="px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-[#C8B993] text-black">
              All Apparel
            </Link>
        ...
        {allClothing.length === 0 ? (
          <div className="text-center py-16 bg-[#1D1D1D] rounded-3xl border border-[#2A2A2A] space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {allClothing.map((product) => (
              <div
                key={product.id}
                className="group flex flex-col bg-[#1D1D1D] border border-[#2A2A2A] rounded-2xl overflow-hidden hover:border-[#C8B993]/40 transition-all hover:shadow-xl hover:shadow-[#C8B993]/5"
              >
                {/* Product Image */}
                <Link href={`/shop/${product.id}`} className="relative aspect-square overflow-hidden bg-[#111111]">
                  <Image
                  ...
                  />
                  <span className="absolute top-2.5 right-2.5 bg-[#C8B993] text-black text-[9px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded shadow-md">
                    COMING SOON
                  </span>
                ...
                <div className="p-4 flex-1 flex flex-col justify-between space-y-3">
                  <div>
                    <Link href={`/shop/${product.id}`} className="block">
                      <h3 className="text-sm font-bold text-white group-hover:text-[#C8B993] transition-colors line-clamp-2 leading-snug">
                        {product.name}
                      </h3>
                    </Link>
                  ...
                  <div className="space-y-3 pt-2 border-t border-[#1a1a1a]">
                    <div className="flex items-baseline justify-between">
                      <span className="text-base font-extrabold text-[#C8B993]">{product.price}</span>
      ...
      <section className="bg-[#1D1D1D] border-t border-[#2A2A2A] py-16 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-[#141414] border border-[#222] rounded-2xl p-6 space-y-3 text-center">
              <div className="w-12 h-12 rounded-xl bg-[#C8B993]/10 text-[#C8B993] flex items-center justify-center mx-auto text-xl font-bold">
                1
              </div>
