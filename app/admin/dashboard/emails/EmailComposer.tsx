...
const TEMPLATES = [
  {
    ...
    subject: "🔥 Exclusive Sale — Up to 25% Off at Bevanssons",
    ...
    ctaUrl: "https://gadgets.bevanssons.store/shop",
  },
  {
    id: "cart",
    label: "Cart Reminder",
  ...
  },
  {
    ...
    subject: "How is your order from Bevanssons?",
    heading: "How's everything going?",
    body: "Hi there,\n\nWe hope you're enjoying your recent purchase from Bevanssons!\n\nIf you have any questions or need any support, we're always here to help. Feel free to reach out anytime.",
    ctaText: "Contact Us",
    ctaUrl: "https://gadgets.bevanssons.store/contact",
  },
  {
    id: "new_arrivals",
    label: "New Arrivals",
    subject: "New arrivals just dropped at Bevanssons 🚀",
